            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 sm:mb-8">
                    <div>
                        ...
                        <p className="text-gray-400 text-xs sm:text-sm font-medium">Manage your restaurant business in real-time</p>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-4 self-end sm:self-auto">
                        <div className="relative" ref={notifRef}>
                            <div
                                onClick={() => setShowNotifications(!showNotifications)}
                                className="relative p-2.5 bg-white rounded-2xl shadow-sm border border-gray-100 cursor-pointer hover:bg-gray-50 transition-all group"
                            >
                                <FaBullhorn className="text-pink-500 group-hover:scale-110 transition-transform" />
                                {orders.filter(o => o.status === 'Pending').length > 0 && (
                                    <span className="absolute -top-2 -right-2 w-5 h-5 bg-red-500 border-2 border-white rounded-full flex items-center justify-center text-[10px] text-white font-bold">
                            ...
                            {showNotifications && (
                                <div className="absolute right-0 top-12 w-[85vw] sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                                    <div className="p-4 bg-pink-50 border-b border-pink-100">
                                        <h3 className="font-bold text-gray-800 text-sm">🔔 Action Required</h3>
                                        <p className="text-xs text-gray-500 mt-0.5">Pending orders waiting to be prepared</p>
                                    </div>
                ...
                {/* --- LIVE PROMO PREVIEW --- */}
                <div className="mb-8">
                    <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2 ml-6">Live Flyer Preview (Customer View)</h3>
                    <PromoFlyer />
                </div>
