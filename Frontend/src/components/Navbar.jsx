                            ...
                            {showNotifications && (
                                <div className="absolute right-[-10px] sm:right-0 top-12 w-[88vw] max-w-[320px] sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                                    <div className="p-3 sm:p-4 bg-orange-50 border-b border-orange-100">
                                        <h3 className="font-bold text-gray-800 text-xs sm:text-sm"> Bell Notifications</h3>
                                        <p className="text-[10px] sm:text-xs text-gray-500 mt-0.5">Your recent order updates</p>
                                    </div>
